...
function Receipt() {
    ...
    const [generating, setGenerating] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
        ...
        const badges = {
            ...
            "in-transit": {
                ...
                icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                    ...
                    viewBox: "0 0 20 20",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
    ...
    const generatePDF = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to generate PDF");
            return null;
        } finally{
            setGenerating(false);
        }
    ...
    const handleShareWhatsApp = async ()=>{
        ...
        try {
            ...
            if (navigator.canShare && navigator.canShare({
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Shared successfully!");
            } else {
                // Fallback: Share text with WhatsApp Web link
                const message = encodeURIComponent(`*OZONE MINERAL WATER - ORDER RECEIPT*\n\n` + `*Shop:* ${orderData.shopName}\n` + `*Address:* ${orderData.shopAddress}\n` + `*Contact:* ${orderData.shopContact}\n\n` + `*Order Items:*\n` + orderData.orderItems.map((item, idx)=>`${idx + 1}. ${item.size} × ${item.quantity} = Rs. ${item.price * item.quantity}/-`).join("\n") + `\n\n*Total Amount:* Rs. ${orderData.totalPrice}/-\n` + `*Payment Status:* ${getPaymentBadge(orderData.paymentStatus).label}\n` + (orderData.paymentStatus === "partially-paid" ? `*Paid Amount:* Rs. ${orderData.paidAmount}/-\n*Remaining:* Rs. ${orderData.remainingAmount}/-\n` : "") + `*Order Status:* ${getStatusBadge(orderData.status).label}\n\n` + `Thank you for your order! 💧`);
                const whatsappUrl = `https://wa.me/${orderData.shopContact.replace(/\D/g, "")}?text=${message}`;
                window.open(whatsappUrl, "_blank");
                __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Opening WhatsApp...");
            }
        } catch (error) {
            console.error("Error sharing:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to share receipt");
        } finally{
            setGenerating(false);
        }
    };
