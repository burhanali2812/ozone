...
var __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OZONE/ozone-water-1/node_modules/html2canvas/dist/html2canvas.esm.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$node$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OZONE/ozone-water-1/node_modules/jspdf/dist/jspdf.node.min.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Receipt() {
    ...
    const captureReceiptImage = async ()=>{
        ...
        try {
            const canvas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(receiptRef.current, {
                scale: 9,
                useCORS: true,
                allowTaint: true,
                logging: false,
    ...
    const generatePDF = async ()=>{
        ...
        try {
            ...
            const pdf = new __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$node$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]({
    ...
    const handleShareWhatsApp = async ()=>{
        ...
        try {
            ...
            const imgData = await captureReceiptImage();
            if (!imgData) {
                __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to capture receipt");
                setGenerating(false);
                return;
            }
    ...
    const openWhatsAppWithImage = (whatsappNumber, imgData)=>{
        ...
        link.href = imgData;
        link.download = `OZONE_Receipt_${orderData.shopName.replace(/\s+/g, "_")}.png`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d253123._.js.map