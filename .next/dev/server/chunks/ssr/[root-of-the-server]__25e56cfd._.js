    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            if (response.data.success) {
                alert("Raw items saved successfully!");
                setSupplierData({
                    supplierName: "",
                    supplierContact: ""
                });
            ...
            alert(error.response?.data?.message || "Failed to save raw items");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25e56cfd._.js.map