...
"[project]/OZONE/ozone-water-1/src/app/api/worker/attendance/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '../../../../models/WorkerAttendance'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
async function GET(request) {
    try {
        ...
        if (id) {
            const attendance = await WorkerAttendance.findById(id).populate("workerId");
            if (!attendance) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(attendance);
        }
        // Build query
        let query = {};
        ...
        const attendances = await WorkerAttendance.find(query).populate("workerId").sort({
            checkIn: -1
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(attendances);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b236f43d._.js.map