...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$lib$2f$stockHelpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addStock"])({
            productId,
...
async function PATCH(request) {
    try {
        ...
        if (!productId || !quantityToReduce || Number(quantityToReduce) <= 0) {
            return new Response(JSON.stringify({
                success: false,
                message: "productId and a positive quantityToReduce are required"
            }), {
                status: 400
            });
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OZONE$2f$ozone$2d$water$2d$1$2f$lib$2f$stockHelpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reduceStock"])({
            productId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d63a7f0._.js.map